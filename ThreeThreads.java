...
public class ThreeThreads {
    ...
    public static void main(String[] args) {
        ...
        City[] group1 = new City[9];
        City[] group2 = new City[9];
        City[] group3 = new City[9];
        
        System.arraycopy(cities, 0, group1, 0, 9);
        System.arraycopy(cities, 9, group2, 0, 9);
        System.arraycopy(cities, 18, group3, 0, 9);
        ...
        for (int run = 0; run < 10; run++) {
            ...
            Thread thread1 = new Thread(new WeatherTask(group1));
            Thread thread2 = new Thread(new WeatherTask(group2));
            Thread thread3 = new Thread(new WeatherTask(group3));
